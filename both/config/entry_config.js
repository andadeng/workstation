Meteor.startup(function () {
	...
	logo: '/assets/logo.png',                  // if set displays logo above sign-in options
	...
	// 	required: false                           // Adds html 5 required property if true
	// }],
	fluidLayout: false,               // Set to true to use bootstrap3 container-fluid and row-fluid classes.
	useContainer: false,               // Set to false to use an unstyled "accounts-entry-container" class instead of a bootstrap3 "container" or "container-fluid" class. 
	...
	showSpinner: false,                // Show the spinner when the client is talking to the server (spin.js)
